 ...
 *
 *  Portions borrowed from SDL, http://libsdl.org
 */

#include "DWHIDUtilities.h"
...
int DWHID_JoystickInit()
{
	...
	hidMatchDictionary = IOServiceMatching ("DWXBoxHIDDriver");
 ...
 */
void DWHID_JoystickUpdate(id target)
{
